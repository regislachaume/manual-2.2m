...
\hfill
\subfigure[Retrieve the \gls{ag} field]{\includegraphics[width=0.45\linewidth]{wfi/ag/wfi-ag-02-retrieve-field.jpg}\label{fig:guidewfi-2}}\\
\subfigure[Pick the guide star]{\includegraphics[width=0.8\linewidth]{wfi/ag/wfi-ag-03-pick.jpg}\label{fig:guidewfi-3}}
\caption[Guide with WFI]{WFI guiding for targets outside the solar system}
\end{figure*}

\procedure{Guide with WFI}
\label{proc:guidewfi}
\begin{enumerate}
