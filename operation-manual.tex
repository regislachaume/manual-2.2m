...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{enumerate}
    \end{enumerate}
    \item\label{list:refine:coord} Enter coordinates 
    \begin{enumerate}
        \item On \gls{pickobj}, copy the value of \texttt{Image X}
        \item On popup \texttt{Enter coordinates}, paste the value in \texttt{X coordinate}
        \item Do the same for \texttt{Image X}
        \item Click \texttt{OK} on the popup \texttt{Enter coordinates}
    \end{enumerate}
