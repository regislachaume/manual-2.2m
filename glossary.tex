...
\newglossaryentry{environment}{name=environment,description={A specific set of computer processes and database values dedicated to a specific job for the instrument and telescope operations.}}
\newglossaryentry{vot}{name=\texttt{vot},sort=vot,description={Visitor Observing Tool, a graphical user interface on the \gls{w2p2dhs} workstation dealing with the distribution of observing blocks to each instrument.}}
\newglossaryentry{p2}{name=\texttt{p2},sort=p2,description={Phase 2, a web interface to create observing blocks and organise the execution sequence}}
...
\newglossaryentry{vme}{name=VME,description={virtual machine environment, used metonymously to describe the \glslink{lcu}{local control unit} controlling the telescope. (VME describes the operating system running on logical control units, but this manual will not use this definition.)}}
...
\newglossaryentry{w2p2tcs}{name=\texttt{w2p2tcs},sort=w2p2tcs,description={Environment (user \texttt{tcs@w2p2tcs}) and eponymous workstation of the Telescope Control software}}
\newglossaryentry{w2p2wfi}{name=\texttt{w2p2wfi},sort=w2p2wfi,description={Environment corresponding to WFI operations (user \texttt{wfi@w2p2ins}, graphic user \texttt{wfi})}}
\newglossaryentry{slit}{name=dome slit,description={Dome slit, through which it is observed when open}}
\newglossaryentry{w2p2ins}{name=\texttt{w2p2ins},sort=w2p2ins,description={Workstation of WFI}}
...
\newglossaryentry{workstation}{name=workstation,description={A computer, with or without a scree attached, that runs some unix or linux flavour.  In opposition to LCU and terminal.}}
\newglossaryentry{wwffcd}{name=\texttt{wwffcd},sort=wwffcd,description={Environment and eponymous workstation controlling the \gls{wfi} detector electronics (\gls{fiera})}}
\newglossaryentry{wfefcd}{name=\texttt{wfefcd},sort=wfefcd,description={Environment and eponymous workstation controlling the \gls{feros} detector electronics (\gls{fiera})}}
\newglossaryentry{wgrccd}{name=\texttt{wgrccd},sort=wgrccd,description={Environment and eponymous workstation controlling the \gls{grond} optical detector electronics (\gls{fiera})}}
...
\newglossaryentry{wgrpipe}{name=\texttt{wgrpipe},sort=wgrpipe,description={Workstation controlling the data reduction and the rapid response mode of GROND}}
\newglossaryentry{wlsasm}{name=\texttt{wlsasm},sort=wlsasm,description={Workstation responsible for the astronomical site monitoring, i.e. measurement of weather and sky quality.}}
...
\newglossaryentry{w2p2dhs}{name=\texttt{w2p2dhs},sort=w2p2dhs,description={Environment and eponymous workstation controlling the \acrlong{ob}s}}
...
\newglossaryentry{w2p2pipe}{name=\texttt{w2p2pipe},sort=w2p2pipe,description={Workstation controlling the CERES reduction pipeline for FEROS (work in progress)}}
\newglossaryentry{l2p2agr}{name=\texttt{l2p2agr},sort=l2p2agr,description={Environment and eponymous LCU controlling the GROND autoguider}}
\newglossaryentry{w2p2cam}{name=\texttt{w2p2cam},sort=w2p2cam,description={Environment corresponding to the autoguiders of GROND and FEROS (graphic user \texttt{cam}, workstation user \texttt{cam@w2p2tcs})}}
...
\newglossaryentry{l2p2cam}{name=\texttt{l2p2cam},sort=l2p2cam,description={Environment and eponymous LCU controlling the FEROS autoguider}}
\newglossaryentry{lfeics1}{name=\texttt{lfeics1},sort=lfeics1,description={Environment and eponyous LCU of the FEROS instrument control software}}
\newglossaryentry{lte2p2}{name=\texttt{lte2p2},sort=lte2p2,description={Environment corresponding to the \texttt{vxte2p2} LCU of the telescope control software}}
\newglossaryentry{vxte2p2}{name=\texttt{vxte2p2},sort=vxte2p2,description={LCU of the telescope control software}}
...
\newglossaryentry{lcu}{name=LCU,description={Local control unit, machine in a rack that controls an instrument or telescope subsystem.}}
...
\newglossaryentry{wgrpipe2}{name=\texttt{wgrpipe2},sort=wgrpipe2,description={Second pipeline machine for GROND, locally labelled as \texttt{wgrsaruman}.  It is used for data backup on external disks, shipped to Germany on a regular basis.}}
\newglossaryentry{wgrsaruman}{name=\texttt{wgrsaruman},sort=wgrsaruman,description={Label on the workstation seen as \texttt{wgrpipe2} over the network.}}
\newglossaryentry{ogrccc}{name=\texttt{ogrccc},sort=ogrccc,description={Closed-cycle cooler controller for GROND.}}
\newglossaryentry{ogrds1}{name=\texttt{ogrds1},sort=ogrds1,description={IR temperature controllers and primary motor controller for GROND.}}
\newglossaryentry{ogrds2}{name=\texttt{ogrds2},sort=ogrds2,description={Turbopump monitor.}}
