...
%%%% WFI
%%%%
  \item \label{list:wfistartup}\textbf{\gls{wfi} restart (14 min, in case of problems, see Fig.~\ref{fig:wfi-restart})}\\
...
\begin{enumerate}
  ...
  \item If WFI doesn't pass the self-test, power cycle the WFI electronics 
	\begin{enumerate}
		...
		\item Switch it on.
	\end{enumerate}
  \item  If WFI passes the self-test, do a restart of the FIERA
        \begin{enumerate}
		...
		\item Wait for FIERA to restart (1 min ?)
        \end{enumerate}
