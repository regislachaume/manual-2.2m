...
\begin{figure*}
\subfigure[]{\includegraphics[width=0.45\linewidth]{feros/feros_ff_lamp2_on.png}\label{fig:ff-lamp2-on}}
\hfill
\subfigure[]{\includegraphics[width=0.45\linewidth]{feros/feros_ff_lamp2_off.png}\label{fig:ff-lamp2-off}}
...
\begin{figure*}
\centering
\includegraphics[width=.5\linewidth]{feros/feros-rack.png}
