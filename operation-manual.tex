...
\item \label{list:soft:exit} Exit all sessions except \gls{grond} (1 min)
    \begin{enumerate}
        ...
        \item On the GROND and FEROS AG screen, exit the X environment
...
\begin{enumerate}
    ...
    \item On the p2pp/ot workstation, login as \texttt{visitor}
    \item On the pipeline workstation, login as \texttt{pipeline}
    \item On the FEROS DRS workstation, login as \texttt{astro}
\end{enumerate}
...
\item Restart some processes and applications
    \begin{enumerate}
        \item On the p2pp/ot screen, open \gls{ot}
