...
\hfill
\subfigure[Choose to log if it went fine]{\includegraphics[width=0.45\linewidth]{wfi/focus/wfi-focus-08-ob-finished.jpg}\label{fig:wfifocus-8}}
\caption[Main steps in the focus sequence of WFI]{Main steps in the \gls{focus} sequence of \gls{wfi}.}
\label{fig:wfifocus}
\end{figure*}

\procedure{Focusing with WFI}
